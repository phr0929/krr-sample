      ...
      <div style={{width:'100%',display:'flex',flexDirection:'row',justifyContent:'center',alignItems:'center',height:90,minHeight:90,maxHeight:90,position:'relative',zIndex:100,backgroundColor:'#fff'}}>
        <div style={{width:1200,display:'flex',flexDirection:'row',height:'100%'}}>
          ...
          <div style={{width:'100%',display:'flex',fontSize:16,flexDirection:'row',height:'100%',alignItems:'center',justifyContent:'flex-end'}}>
            ...
            <div style={{padding:20,color:'#969696'}}>English Hi-up</div>
          </div>
        </div>
      </div>
              ...
              <div style={{width:'100%',height:'100%',display:'flex',flexDirection:'row'}}>
                <div style={{width:'100%',display:'flex',height:'100%',justifyContent:'center',}}>
                  <div style={{width:100,minWidth:100,maxWidth:100,display:'flex',flexDirection:'column'}}>
                    <div style={{display:'flex',flex:1,alignItems:'center',justifyContent:'center',height:120,minHeight:120,maxHeight:120}}>자음</div>
                    <div style={{display:'flex',flex:1,alignItems:'center',justifyContent:'center',height:120,minHeight:120,maxHeight:120}}>모음</div>
                    <div style={{display:'flex',flex:1,alignItems:'center',justifyContent:'center',height:120,minHeight:120,maxHeight:120}}>자음+모음</div>
                    <div style={{display:'flex',flex:1,alignItems:'center',justifyContent:'center',height:120,minHeight:120,maxHeight:120}}>4주차</div>
                  </div>
